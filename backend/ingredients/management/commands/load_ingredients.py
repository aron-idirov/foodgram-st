...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../data/ingredients.json'))
        ...
        with open(file_path, encoding='utf-8') as f:
            ...
            for item in data:
                ...
                if created:
                    count += 1
            self.stdout.write(self.style.SUCCESS(f'Загружено {count} новых ингредиентов'))
